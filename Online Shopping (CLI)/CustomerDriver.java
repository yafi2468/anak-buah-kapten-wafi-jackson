...
public class CustomerDriver {
    ...
    private void checkout(Scanner scanner) {
        ...
        Transaksi transaksi = new Transaksi(customer, paymentMethod.getClass().getSimpleName(), keranjang.getItems());
        listTransaksi.addTransaction(transaksi);

        // Membuat dan menampilkan invoice
        Invoice invoice = new Invoice(transaksi, paymentMethod.getClass().getSimpleName());
